...
function Navbar() {
  ...
  return (
    <>
      <nav className="flex items-center justify-between bg-gray-900 shadow-md py-3 px-6 fixed top-0 right-0 left-0 z-10">
        {/* Logo */}
        ...
        <div className="hidden md:flex space-x-6 font-medium">
          <Link to="" className="hover:text-pink-500 text-white">
            Home
          </Link>
          <Link to="#" className="hover:text-pink-500 text-white">
            About Us
        ...
        >
          <div className="relative w-full max-w-xl">
            <input
              ...
              className="text-white w-full pl-12 pr-4 py-3 border border-gray-300 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 text-gray-700"
            />
        ...
        <div className="flex space-x-4 text-gray-900">
          ...
          >
            <FaHeart className="mr-1 text-lg text-white" />
            <span className="hidden md:inline text-white">Wishlist</span>
            {totalWishlist > 0 && (
          ...
          <Link
            ...
            className="flex items-center cursor-pointer relative hover:text-pink-500"
          >
            <FaCartPlus className="mr-1 text-lg text-white" />
          ...
          <div className="flex items-center cursor-pointer relative hover:text-pink-500">
            <FaShoppingBag className="mr-1 text-lg text-white" />
            <span className="hidden md:inline text-white">Order</span>
          </div>
          <div className="flex items-center cursor-pointer hover:text-pink-500">
            <FaUser className="mr-1 text-lg text-white" />
